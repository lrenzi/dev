'use strict';
app.controller('alterarUsuarioModalCtrl', ['$scope', '$uibModalInstance', 'items', 'custom', "usuarioService", 'utilService', function ($scope, $uibModalInstance, items, custom, usuarioService, utilService) {
